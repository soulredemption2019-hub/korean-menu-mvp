...
const DISHES = [
  ...
  {
    roman: "Galbi Gui",
    name: { ko: "갈비구이", en: "Grilled Beef Short Ribs", cn: "烤牛排" },
    desc: {
      ...
      cn: "用酱油酱料腌过的牛排骨炭火烤制，韩国人最喜欢的烤肉之一。"
    },
    ingredients: {
      ko: "소갈비, 간장, 설탕, 마늘, 참기름",
    ...
    tip: {
      ...
      cn: "店里一般由店员帮你烤；贴着骨头的肉最香。"
    },
    spice: 2
  },
  {
    roman: "Galbi Jjim",
    name: { ko: "갈비찜", en: "Braised Short Ribs", cn: "炖排骨" },
    desc: {
    ...
    tip: {
      ...
      cn: "节日或特别日子吃的菜；吸饱酱汁的萝卜很好吃。"
    },
    spice: 2
  },
  {
    roman: "Samgyetang",
    name: { ko: "삼계탕", en: "Ginseng Chicken Soup", cn: "参鸡汤" },
    desc: {
      ...
      cn: "童子鸡腹中填入糯米、人参、红枣炖煮，是韩国传统滋补料理。"
    },
    ingredients: {
      ko: "닭, 찹쌀, 인삼, 대추, 마늘",
    ...
    tip: {
      ...
      cn: "以夏天流汗后进补著称；按口味加盐和胡椒。"
    },
    spice: 1
  },
  {
    roman: "Haemul Pajeon",
    name: { ko: "해물파전", en: "Seafood Scallion Pancake", cn: "海鲜葱饼" },
    desc: {
  ...
  {
    roman: "Sundae",
    name: { ko: "순대", en: "Blood Sausage", cn: "米肠" },
    desc: {
  ...
  {
    roman: "Mandu",
    name: { ko: "만두", en: "Korean Dumplings", cn: "饺子" },
    desc: {
    ...
    tip: {
      ...
      cn: "有煎饺和蒸饺之分；也会放进年糕汤里吃。"
    },
    spice: 1
  },
  {
    roman: "Tteokguk",
    name: { ko: "떡국", en: "Rice Cake Soup", cn: "年糕汤" },
    desc: {
    ...
    tip: {
      ...
      cn: "韩国人说吃了年糕汤才算长一岁；上面放紫菜丝和蛋丝。"
    },
    spice: 1
  },
  {
    roman: "Miyeokguk",
    name: { ko: "미역국", en: "Seaweed Soup", cn: "海带汤" },
    desc: {
      ko: "미역을 넣고 끓인 국으로, 생일날 먹는 대표 음식이에요.",
      en: "Seaweed soup traditionally eaten on birthdays.",
      cn: "海带煮的汤，韩国生日必吃的代表食物。"
    },
    ingredients: {
      ko: "미역, 소고기, 간장, 참기름",
  ...
  },
  {
    ...
    tip: {
      ...
      cn: "趁热吃最嫩；石锅上桌的鸡蛋羹最好吃。"
    },
    spice: 1
  },
  {
    roman: "Agujjim",
    name: { ko: "아구찜", en: "Braised Monkfish", cn: "炖安康鱼" },
    desc: {
  ...
  {
    roman: "Maeuntang",
    name: { ko: "매운탕", en: "Spicy Fish Stew", cn: "辣鱼汤" },
    desc: {
  ...
  },
  {
    ...
    name: { ko: "오징어볶음", en: "Stir-fried Squid", cn: "辣炒鱿鱼" },
    desc: {
  ...
  {
    roman: "Nakji Bokkeum",
    name: { ko: "낙지볶음", en: "Stir-fried Octopus", cn: "辣炒小章鱼" },
    desc: {
  ...
  {
    roman: "Kongnamul Guk",
    name: { ko: "콩나물국", en: "Bean Sprout Soup", cn: "豆芽汤" },
    desc: {
  ...
  {
    roman: "Jajangmyeon",
    name: { ko: "짜장면", en: "Black Bean Noodles", cn: "炸酱面" },
    desc: {
  ...
  {
    roman: "Jjamppong",
    name: { ko: "짬뽕", en: "Spicy Seafood Noodle Soup", cn: "海鲜辣汤面" },
    desc: {
  ...
  {
    roman: "Sujebi",
    name: { ko: "수제비", en: "Hand-torn Dough Soup", cn: "面片汤" },
    desc: {
  ...
  {
    roman: "Makguksu",
    name: { ko: "막국수", en: "Chuncheon Buckwheat Noodles", cn: "荞麦拌面" },
    desc: {
  ...
  {
    roman: "Janchi Guksu",
    name: { ko: "잔치국수", en: "Banquet Noodles", cn: "喜面" },
    desc: {
  ...
  {
    roman: "Hotteok",
    name: { ko: "호떡", en: "Sweet Syrup Pancake", cn: "糖饼" },
    desc: {
    ...
    tip: {
      ...
      cn: "冬天街头最火的小吃；内馅很烫要小心。"
    },
    spice: 1
  },
  {
    roman: "Bungeoppang",
    name: { ko: "붕어빵", en: "Fish-shaped Pastry", cn: "鲫鱼饼" },
    desc: {
  ...
  {
    roman: "Gyeranppang",
    name: { ko: "계란빵", en: "Egg Bread", cn: "鸡蛋面包" },
    desc: {
  ...
  {
    roman: "Dakgangjeong",
    name: { ko: "닭강정", en: "Sweet Crispy Chicken", cn: "韩式糖醋鸡块" },
    desc: {
  ...
  },
  {
    ...
    tip: {
      ...
      cn: "配啤酒的“치맥（炸鸡+啤酒）”是韩国代表文化。"
    },
    spice: 3
  },
  {
    roman: "Huraideu Chicken",
    name: { ko: "후라이드치킨", en: "Fried Chicken", cn: "原味炸鸡" },
    desc: {
    ...
    tip: {
      ...
      cn: "趁热吃最酥脆；很多人点半半（原味+酱料）。"
    },
    spice: 1
  },
  {
    roman: "Kimchi Bokkeumbap",
    name: { ko: "김치볶음밥", en: "Kimchi Fried Rice", cn: "泡菜炒饭" },
    desc: {
      ko: "잘 익은 김치와 밥을 볶아 만든 음식이에요. 간단하고 맛있는 밥 요리예요.",
      en: "Rice stir-fried with well-fermented kimchi. Simple and satisfying.",
      cn: "熟成泡菜和米饭一起炒，简单又好吃的快手饭。"
    },
    ingredients: {
      ko: "밥, 김치, 돼지고기, 달걀, 대파",
      en: "Rice, kimchi, pork, egg, green onion",
      cn: "米饭、泡菜、猪肉、鸡蛋、大葱"
    },
    tip: {
      ko: "위에 달걀 프라이를 올리면 더 맛있어요. 김가루를 뿌려도 좋아요.",
      en: "Top with a fried egg — and shredded seaweed if you like.",
      cn: "盖一个煎蛋更香，撒紫菜丝也好吃。"
    },
    spice: 2
  },
  {
    roman: "Omurice",
    name: { ko: "오므라이스", en: "Omelette Rice", cn: "蛋包饭" },
    desc: {
  ...
  {
    roman: "Yukgaejang",
    name: { ko: "육개장", en: "Spicy Beef Soup", cn: "辣牛肉汤" },
    desc: {
      ko: "소고기와 고사리, 대파를 매운 양념에 끓인 얼큰한 국이에요.",
      en: "A hearty spicy soup with beef, bracken, and lots of green onion.",
      cn: "牛肉、蕨菜、大葱加辣汤熬煮的浓郁汤品。"
    },
    ingredients: {
      ko: "소고기, 고사리, 대파, 고춧가루, 달걀",
      en: "Beef, bracken, green onion, chili powder, egg",
      cn: "牛肉、蕨菜、大葱、辣椒粉、鸡蛋"
    },
    tip: {
      ko: "얼큰한 국물이 땀을 나게 해요. 밥을 말아 먹으면 더 맛있어요.",
      en: "The spicy broth makes you sweat. Pour over rice for extra satisfaction.",
      cn: "辣汤喝到出汗；泡饭吃更爽。"
    },
    spice: 4
  },
  {
    roman: "Seolleongtang",
    name: { ko: "설렁탕", en: "Ox Bone Soup", cn: "牛骨汤" },
    desc: {
    ...
    tip: {
      ...
      cn: "本身几乎没调味，自己加盐和胡椒；配萝卜泡菜吃。"
    },
    spice: 1
  },
  {
    roman: "Gomtang",
    name: { ko: "곰탕", en: "Beef Bone Soup", cn: "浓牛骨汤" },
    desc: {
  ...
  {
    roman: "Sogogi Muguk",
    name: { ko: "소고기무국", en: "Beef Radish Soup", cn: "牛肉萝卜汤" },
    desc: {
  ...
  {
    roman: "Nokdu Jeon",
    name: { ko: "녹두전", en: "Mung Bean Pancake", cn: "绿豆煎饼" },
    desc: {
  ...
  },
  {
    ...
    name: { ko: "동그랑땡", en: "Korean Meat Patties", cn: "韩式肉饼" },
    desc: {
  ...
  {
    roman: "Hobak Jeon",
    name: { ko: "호박전", en: "Zucchini Pancake", cn: "西葫芦煎饼" },
    desc: {
  ...
  },
  {
    ...
    name: { ko: "양념게장", en: "Spicy Marinated Crab", cn: "辣酱腌蟹" },
    desc: {
  ...
  {
    roman: "Jangeo Gui",
    name: { ko: "장어구이", en: "Grilled Eel", cn: "烤鳗鱼" },
    desc: {
    ...
    tip: {
      ...
      cn: "初秋的鳗鱼最肥美；被认为能恢复体力。"
    },
    spice: 2
  },
  {
    roman: "Godeungeo Gui",
    name: { ko: "고등어구이", en: "Grilled Mackerel", cn: "烤鲭鱼" },
    desc: {
  ...
  {
    roman: "Gopchang Gui",
    name: { ko: "곱창구이", en: "Grilled Beef Tripe", cn: "烤牛小肠" },
    desc: {
      ko: "소의 작은 창자를 양념해 구워 먹는 음식이에요. 쫄깃하고 고소해요.",
      en: "Seasoned and grilled small beef intestines. Chewy, rich, and savory.",
      cn: "牛小肠调味烤制，弹韧油香。"
    },
    ingredients: {
      ko: "곱창, 소금, 대파, 마늘, 양파",
      en: "Beef tripe, salt, green onion, garlic, onion",
      cn: "牛小肠、盐、大葱、大蒜、洋葱"
    },
    tip: {
      ko: "기름기가 많아서 숯불에 구우면 더 고소해요. 마무리 볶음밥도 인기예요.",
      en: "The rich fat gets smoky-sweet over charcoal. Fried rice at the end is popular.",
      cn: "油脂多，炭火烤更香；结尾炒饭也很火。"
    },
    spice: 2
  },
  {
    roman: "Makchang Gui",
    name: { ko: "막창구이", en: "Grilled Pork Intestines", cn: "烤猪大肠" },
    desc: {
  ...
  {
    roman: "Jokbal",
    name: { ko: "족발", en: "Pig's Trotters", cn: "卤猪蹄" },
    desc: {
  ...
  {
    roman: "Bossam",
    name: { ko: "보쌈", en: "Boiled Pork Wraps", cn: "菜包肉" },
    desc: {
    ...
    tip: {
      ...
      cn: "冬季生蚝菜包肉特别有名；配包饭酱和大蒜。"
    },
    spice: 1
  },
  {
    roman: "Yukhoe",
    name: { ko: "육회", en: "Beef Tartare", cn: "生拌牛肉" },
    desc: {
  ...
  },
  {
    ...
    name: { ko: "돌솥비빔밥", en: "Stone Pot Bibimbap", cn: "石锅拌饭" },
    desc: {
    ...
    tip: {
      ...
      cn: "石锅非常烫要小心；刮锅底的锅巴吃是美味。"
    },
    spice: 2
  },
  {
    roman: "Bibim Guksu",
    name: { ko: "비빔국수", en: "Spicy Cold Noodles", cn: "拌面" },
    desc: {
  ...
  },
  {
    ...
    tip: {
      ...
      cn: "传统上食材要摆成一圈；常出现在宫廷套餐里。"
    },
    spice: 1
  },
  {
    roman: "Gujeolpan",
    name: { ko: "구절판", en: "Nine-section Platter", cn: "九折坂" },
    desc: {
    ...
    tip: {
      ...
      cn: "每种料夹进薄饼卷着吃，一口多种味道。"
    },
    spice: 1
  },
  {
    roman: "Dakbal",
    name: { ko: "닭발", en: "Spicy Chicken Feet", cn: "辣鸡爪" },
    desc: {
  ...
  },
  {
    ...
    name: { ko: "골뱅이무침", en: "Sea Snail Salad", cn: "凉拌海螺" },
    desc: {
  ...
  {
    roman: "Kkotgetang",
    name: { ko: "꽃게탕", en: "Blue Crab Stew", cn: "花蟹汤" },
    desc: {
  ...
  {
    roman: "Jogaetang",
    name: { ko: "조개탕", en: "Clam Soup", cn: "蛤蜊汤" },
    desc: {
  ...
  },
  {
    ...
    name: { ko: "바지락칼국수", en: "Clam Noodle Soup", cn: "蛤蜊刀切面" },
    desc: {
  ...
  {
    roman: "Nurungji",
    name: { ko: "누룽지", en: "Scorched Rice", cn: "锅巴" },
    desc: {
  ...
  {
    roman: "Yakbap",
    name: { ko: "약밥", en: "Sweet Rice with Dates", cn: "药饭" },
    desc: {
  ...
  },
  {
    ...
    tip: {
      ...
      cn: "垫松针蒸有松香；俗语说包得漂亮能生漂亮女儿。"
    },
    spice: 1
  },
  {
    roman: "Injeolmi",
    name: { ko: "인절미", en: "Soybean Powder Rice Cake", cn: "豆粉年糕" },
    desc: {
  ...
  {
    roman: "Gyeongdan",
    name: { ko: "경단", en: "Rice Ball Cakes", cn: "米团糕" },
    desc: {
  ...
  },
  {
    ...
    name: { ko: "찹쌀떡", en: "Glutinous Rice Cake", cn: "糯米糕" },
    desc: {
  ...
  {
    roman: "Sikhye",
    name: { ko: "식혜", en: "Sweet Rice Drink", cn: "食醯（甜米露）" },
    desc: {
  ...
  },
  {
    ...
    tip: {
      ...
      cn: "夏天传统饮品；水果切漂亮点更有食欲。"
    },
    spice: 1
  },
  {
    roman: "Yuja-cha",
    name: { ko: "유자차", en: "Citron Tea", cn: "柚子茶" },
    desc: {
  ...
  {
    roman: "Insam-cha",
    name: { ko: "인삼차", en: "Ginseng Tea", cn: "人参茶" },
    desc: {
  ...
  {
    roman: "Daechu-cha",
    name: { ko: "대추차", en: "Jujube Tea", cn: "大枣茶" },
    desc: {
  ...
  {
    roman: "Omija-cha",
    name: { ko: "오미자차", en: "Schisandra Tea", cn: "五味子茶" },
    desc: {
  ...
  },
  {
    ...
    name: { ko: "시금치나물", en: "Seasoned Spinach", cn: "凉拌菠菜" },
    desc: {
  ...
  {
    roman: "Gamja Jorim",
    name: { ko: "감자조림", en: "Braised Potatoes", cn: "炖土豆" },
    desc: {
  ...
  },
  {
    ...
    tip: {
      ...
      cn: "便当代表菜；胡萝卜和葱切碎拌入蛋液。"
    },
    spice: 1
  },
  {
    roman: "Twigim",
    name: { ko: "튀김", en: "Korean Fried Fritters", cn: "韩式炸物" },
    desc: {
  ...
  },
  {
    ...
    name: { ko: "오징어순대", en: "Stuffed Squid", cn: "鱿鱼米肠" },
    desc: {
  ...
  {
    roman: "Chueo-tang",
    name: { ko: "추어탕", en: "Loach Soup", cn: "泥鳅汤" },
    desc: {
  ...
  {
    roman: "Hobakjuk",
    name: { ko: "호박죽", en: "Pumpkin Porridge", cn: "南瓜粥" },
    desc: {
  ...
  {
    roman: "Patjuk",
    name: { ko: "팥죽", en: "Red Bean Porridge", cn: "红豆粥" },
    desc: {
  ...
  },
  {
    ...
    tip: {
      ...
      cn: "分量足适合2-3人；加方便面也好吃。"
    },
    spice: 4
  },
  {
    roman: "Oi Naengguk",
    name: { ko: "오이냉국", en: "Cold Cucumber Soup", cn: "黄瓜冷汤" },
    desc: {
  ...
  {
    roman: "Daechang Gui",
    name: { ko: "대창구이", en: "Grilled Beef Intestines", cn: "烤牛大肠" },
    desc: {
  ...
  {
    roman: "Galchi Jorim",
    name: { ko: "갈치조림", en: "Braised Hairtail", cn: "炖带鱼" },
    desc: {
    ...
    tip: {
      ...
      cn: "吸满汤汁的萝卜是精华；汤汁拌饭一流。"
    },
    spice: 3
  },
  {
    roman: "Samgak Gimbap",
    name: { ko: "삼각김밥", en: "Triangular Rice Balls", cn: "三角饭团" },
    desc: {
      ...
      cn: "三角造型的紫菜饭团，韩国便利店销量冠军。"
    },
    ingredients: {
      ko: "밥, 김, 참치마요, 소고기, 스팸",
      en: "Rice, seaweed, tuna mayo, beef, spam",
      cn: "米饭、紫菜、金枪鱼蛋黄酱、牛肉、午餐肉"
    },
    tip: {
